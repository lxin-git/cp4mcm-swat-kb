...
<ArticleDetails name="Mark Leftwich" lastUpdated="Aug 6th" readTimeMinutes="10" />

## Complete overview of all the below steps in a single short video


<iframe src="https://video.ibm.com/embed/recorded/127528091" style="border: 0;" webkitallowfullscreen allowfullscreen frameborder="no" width="720" height="405"></iframe>
...
[![Foo](./macdown1.png)](https://macdown.uranusjr.com/)
...
I have modified the code so it displays text in this article rather that the banner you see in the finished result:
 ...
 ``` 
.(../../../images/SWAT_Header.gif)(http://localhost:8000/) 
